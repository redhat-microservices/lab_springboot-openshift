...
[source]
----
project-new --named cdfront --type jar
----

. Transform it into a Spring Boot project
+
[source]
----
spring-boot-new-project --dependencies web
----

. Change the port number to be use by editing the application.properties file and adding this key
+
[source]
----
server.port=8081
