...
. Open the Hystric dashboard to view the status of the circuit breaker. It should be `close`
+
...
. Go back to the `Hystrix dashboard` to verify that the ctstaus of the circuit breaker is `open` now.
