...
NOTE: If you don't have enough memory on your machine to launch a Hypervisor with Minishift, then ask to the instructor to https://docs.google.com/spreadsheets/d/1tO5KYSaJtoO1em1A2wnIvJnm7SkIzLihLfU7kFSCRDQ/edit?usp=sharing[have access] to an Openshift platform running in the cloud.
