...
. We are almost set. The last step of this module section will consist to use this JBoss Forge scaffold command.
  This command will populate the static Web content which is an AngularJS 1 application. This Frontend contains the screens
  required to perform the CRUD operations to call the REST services `http://localhost:8080/rest/catalogs`
+
[source]
----
