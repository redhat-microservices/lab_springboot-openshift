...
- [x] http://github.com/minishift/minishift[Minishift v1.0.1]
...
In order to use JBoss Forge with this lab, 2 addons should be installed to be able to setup Spring Boot and Fabric8
