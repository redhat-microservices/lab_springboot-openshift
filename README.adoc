...
NOTE: IF you must execute the command using another version o JBoss Forge installed on tour machine, you can also pass the pass to access the forge executable using an env var
      `FORGE_PATH=$HOME/MyForge/forge ./scripts/setup.sh demo`
