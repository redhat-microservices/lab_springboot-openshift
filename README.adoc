...
. Open a terminal where we will create the workshop project
...
----
cd ..
cp ../scripts/service/data.sql cdservice/src/main/config-local
cp ../scripts/service/data.sql cdservice/src/main/config-openshift
----
